...
static void	print_symtab_32(symtab_t *tab, size_t size) {
...
static void	read_symtab_32(struct symtab_command *symcmd, symtab_t *tab, \
						   void *ptr) {
...
static void	*read_symtab_cmd_32(uint32_t ncmds, uint32_t lcoff, void *ptr) {
...
int			nm_macho32(void *ptr) {
	...
	symcmd = read_symtab_cmd_32(header->ncmds, sizeof(*header), ptr);
